		...
		if (!empty($enviar2)) {
			...
			$title=$_POST['titulo'];
			 ...
			 if ($ex=='.jpg' or $ex=='.png' or $ex=='jpg' or $ex=='png' or $ex=='.jpeg' or $ex=='jpeg'){
				 	 $bd->ejecutar("insert into artistas_fotos values(NULL,'$aid','$title','$dirxc','$fec','0')");
					 $nompic1=$bd->lastID();
		   ...
		   $ex=".jpg";
			...
			?>
				...
				top.location="crop.php?id=<?=$nompic1?>";
				</script>
...
<div style="width: 930px; float: left; margin: 10px 0;">
  ...
  <tr>
    <td colspan="4" align="center" valign="middle" class="Arial12Gris"><table align="center">
      ...
      <tr>
        <td align="center"><form action="addfotos.php" method="post" enctype="multipart/form-data" name="reduce" id="reduce">
