		...
		if (!empty($enviar2)) {
			...
			$video=$_POST['video'];
			 ...
			 $hora=date("H:i:s");
				 	 ...
				 	 $bd->ejecutar("insert into  artistas_videos values(NULL,'$aid','$title','$video','$fec','0')");
					 $nompic1=$bd->lastID(); 
...
<div style="width: 930px; float: left;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="83%" bgcolor="#C41230" style=" "><? include "menu2.php"; ?></td>
  </tr>
</table>
</div>
...
<div style="width: 930px; float: left; margin: 10px 0;">
  ...
  <tr>
    <td colspan="4" align="center" valign="middle" class="Arial12Gris"><table align="center">
      <tr>
        <td><span class="Verdana16Ngo"><strong>Agrega Video</strong></span></td>
      </tr>
      <tr>
        <td align="center"><form action="addvideo.php" method="post" enctype="multipart/form-data" name="reduce" id="reduce">
          <table width="500" align="center" cellpadding="4" cellspacing="4">
            <tr>
              <td width="21%" align="left" valign="middle" class="Hevel16Gris"><strong><span class="titulo1">Video YouTube</span></strong></td>
              <td width="79%" align="left" class="menu"><span class="arial11Negro">
                <input name="video" type="text" id="video" maxlength="13" />
                <br />
                <strong>Ejemplo: </strong>solo poner el codigo en negritas correspondiente a 11 caracteres depuse de &quot;v=' y en ocaciones hasta antes de &quot;&amp;&quot;<br />
</span><span class="Arial12Rojo">http://www.youtube.com/watch?v=</span><span class="arial11Negro"><strong>cpNDbQhoMBk</strong></span><span class="Arial12Rojo">&amp;feature=related </span></td>
            </tr>
            <tr>
