...
correo
url*/
	 $bd->ejecutar("insert into directorio values(NULL, '$secc', '$orden', '$nombre', '$puesto','$domicilio','$telefono','$exten','$correo','')");
...
<div  style="float:left; width:960px; ">
  ...
  <table width="50%" align="center">
    <tr>
      <td><span class="Verdana16Ngo"><strong>Agrega </strong></span></td>
      </tr>
    <tr>
        ...
        <table width="100%" align="center" cellpadding="4" cellspacing="4">
          ...
          <tr>
            ...
            <td align="left" class="Arial12Gris"><label for="orden"></label>
              <input name="orden" type="text" id="orden" size="5" style="width:30px" /> 
          ...
          <tr>
            ...
            <td align="left" class="menu"><label for="direccion"></label>
              <textarea name="direccion" rows="3" id="direccion" style="width:100%" ></textarea></td>
          </tr>
          <tr>
