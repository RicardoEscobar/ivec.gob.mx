...
$rsx=$bd->ejecutar("select id from  cartelera order by fecha desc");	
  ...
  <tr>
    ...
    <tr>
      <td align="center" ><table width="100%" border="0" align="center" cellpadding="4" cellspacing="4" >
          ...
          <td align="left"  class="negro1"><table width="600" border="0" align="center" cellpadding="4" cellspacing="0" >
            <tr class="Hevel16Gris" <? if ($wf%2==0) { echo $sty; } ?> >
              <td colspan="2" align="left" valign="middle"  class="Arial12Gris"><table width="600" border="0" align="center" cellpadding="4" cellspacing="0" >
                <tr>
                  <td colspan="6" align="center"  class="Verdana16Ngo"><strong>Administrar Cartelera <a href="addcartelera.php"><img src="imagenes/m.png" border="0"  title="Nuevo"/></a></strong></td>
                </tr>
                <tr class="Hevel16Gris">
                  <td width="300" align="left"  class="text2"><strong>Titulo</strong></td>
                  <td width="100" align="left"  class="text2"><strong>Fecha</strong></td>
		...
		if ($page!='')
		{
			$_SESSION['caretxpahe']=$page;
		}
		if ($page=='')
		{
			$page=$_SESSION['caretxpahe'];
		}
		...
		while($row = $pagedResults->fetchPagedRow()) {
			$ids.=','.$row;
						...
						$sqll="Select * from  cartelera where id in ($ids) order by fecha desc";
                ...
                <tr class="Hevel16Gris" <? if ($wf%2==0) { echo $sty; } ?> >
                  ...
                  <td align="left" valign="middle"  class="Arial12Gris"><?=$bd->fechacp($rowl['fecha']);?>&nbsp;</td>
                  <td align="center" valign="middle"  class="Arial12Gris"><? if (file_exists($rowl['url'])){ ?>
                    ...
                    <? } ?></td>
                  <td align="center" background="../imagen/back1.jpg"  class="link"><a href="upcartelera.php?id=<?=$rowl['id'];?>" ><img src="imagenes/up.png" border="0" title="Modificar" /></a></td>
                  <td align="center" background="../imagen/back1.jpg"  class="link"><a href="delcartelera.php?id=<?=$rowl['id'];?>" class="text1" onclick = "if (! confirm('&iquest;Realmente desea eliminar : <?=$rowl['nombre']?>?')) return false;"><img src="imagenes/del.png" border="0" title="Eliminar" /></a></td>
                </tr>
                <?  $wf++; } ?>
              </table></td>
            </tr>
