...
$id=$_GET['id'];
$busca=$bd->ejecutar("select * from cartelera where id=$id");
$rowc=$bd->obtener_fila($busca,0);
...
if (!is_dir($fot)){
 ...
 $bd->ejecutar("update cartelera set fecha='$theDate2', titulo='$tituloa' where id=$id");
	$nompic1=$id; 
...
<table width="900" align="center">
  <tr>
    ...
    <tr>
      <td align="center" ><form action="upcartelera.php?id=<?=$id?>" method="post" enctype="multipart/form-data"><table width="100%" border="0" align="center" cellpadding="4" cellspacing="4" >
        <tr class="columna">
          <td align="left"  class="negro1"><table width="600" border="0" align="center" cellpadding="4" cellspacing="0" >
            <tr>
              <td colspan="5" align="center"  class="Verdana16Ngo"><strong>Modificar Cartelera</strong></td>
            </tr>
            ...
            <tr class="Hevel16Gris">
              ...
              <td colspan="2" align="left"  class="text2"><label for="tituloa"></label>
                <input type="text" name="tituloa" id="tituloa" value="<?=$rowc['titulo'];?>" /></td>
            ...
            <tr class="Hevel16Gris">
              ...
              <td align="left"  class="text2"><input name="theDate2" type="text" value="<?=$rowc['fecha'];?>" size="15" readonly onClick="displayCalendar(document.forms[0].theDate2,'yyyy-mm-dd',this)" /></td>
            ...
            <tr class="Hevel16Gris">
              ...
              <td colspan="2" align="left"  class="Arial11RojoM">Se reemplaza en caso de seleccionar un archivo</td>
              </tr>
            <tr class="Hevel16Gris">
