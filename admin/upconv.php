...
$busc=$bd->ejecutar("select * from convocatorias where id=$id");
$rowc=$bd->obtener_fila($busc,0);
...
$link=$_POST['link'];
 ...
 $bd->ejecutar("update convocatorias set organiza='$reponsable', tema='$tituloa', descr1='$info', finicio='$theDate2', ffin='$theDate3', edo='$edo', link='$link' where id=$id");
	$nompic1=$id; 
...
<table width="900" align="center">
  <tr>
    ...
    <tr>
      <td align="center" ><form action="upconv.php?id=<?=$id?>" method="post" enctype="multipart/form-data"><table width="100%" border="0" align="center" cellpadding="4" cellspacing="4" >
        <tr class="columna">
          <td align="left"  class="negro1"><table width="600" border="0" align="center" cellpadding="4" cellspacing="0" >
            ...
            <tr class="Hevel16Gris">
              ...
              <td colspan="2" align="left"  class="text2"><label for="tituloa"></label>
                <input name="tituloa" type="text" id="tituloa" value="<?=$rowc['tema'];?>" /></td>
            ...
            <tr class="Hevel16Gris">
              ...
              <td align="left"  class="text2"><input name="theDate2" type="text" value="<?=$rowc['finicio'];?>" size="15" readonly onClick="displayCalendar(document.forms[0].theDate2,'yyyy-mm-dd',this)" /></td>
              <td align="center"  class="arial13Negro">&nbsp;</td>
              <td align="left"  class="text2">&nbsp;</td>
              </tr>
            <tr class="Hevel16Gris">
              <td align="left"  class="arial13Negro"><p>Fin</p></td>
              <td align="left"  class="text2"><input name="theDate3" type="text" value="<?=$rowc['ffin'];?>" size="15" readonly onClick="displayCalendar(document.forms[0].theDate3,'yyyy-mm-dd',this)" /></td>
              <td align="center"  class="arial13Negro">&nbsp;</td>
              <td align="left"  class="text2">&nbsp;</td>
              ...
              <td colspan="2" align="left"  class="text2"><label for="organiza"></label>
                ...
                <input type="text" name="reponsable" id="reponsable" value="<?=$rowc['organiza'];?>" /></td>
              <td align="left"  class="text2">&nbsp;</td>
              </tr>
              <tr class="Hevel16Gris">
                <td height="40" align="left"  class="arial13Negro">Link Completo</td>
                <td colspan="2" align="left"  class="text2"><label for="link"></label>
                  <input type="text" name="link" id="link"  value="<?=$rowc['link'];?>" /></td>
                <td align="left"  class="text2">&nbsp;</td>
                </tr>
              <tr class="Hevel16Gris">
              <td height="40" align="left"  class="arial13Negro">info Extra</td>
              <td colspan="2" align="left"  class="text2"><textarea name="info" rows="5" id="info"><?=$rowc['descr1'];?></textarea></td>
              <td align="left"  class="text2">&nbsp;</td>
            </tr>
            <tr class="Hevel16Gris">
              ...
              <td align="left"  class="text2"><label for="edo"></label>
                <select name="edo" id="edo">
                  <option value="1" <? if ($rowc['edo']==1){ echo 'selected="selected"'; } ?>  >Activo</option>
            ...
            <tr class="Hevel16Gris">
              ...
              <td align="center"  class="text2">&nbsp;</td>
              <td rowspan="2" align="left"  class="Arial11RojoM"><strong>* Si selecciona un archivo se reemplazara en anterior en cualquiera de los casos en caso de que haya sido cargdo con aterioridad.</strong></td>
            </tr>
            <tr class="Hevel16Gris">
