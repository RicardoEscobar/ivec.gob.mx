...
$nf=@$bd->obtener_fila($kn,0);
 ...
 if ($agrega2!=''){
	 ...
	 $bd->ejecutar("update recintos set nombre='$nombre', historia='$historia', actividades='$actividad', areas='$areas', direccion='$direccion', mapa='$mapa', contacto='$contacto' where id=$id");
...
<textarea name="historia" cols="80" rows="8" id="historia"><?=stripslashes($nf['historia']); ?></textarea>
		...
		else 
		{
		   ...
		   ?>
            ...
            <br />
            <textarea name="areas" cols="80" rows="8" class="tex" id="areas"><?=stripslashes($texto); ?></textarea></td>
          </tr>
        <tr>
		...
		else 
		{
		   ...
		   ?>
              ...
              <br />
              <textarea name="direccion" cols="80" rows="8" class="tex" id="direccion"><?=stripslashes($texto); ?></textarea></td>
          </tr>
          <tr>
            <td align="left" class="arial14Negro" style="padding:10px 0"><strong>Contacto</strong></td>
            <td align="left" style="padding:10px 0"><textarea name="contacto" cols="80" rows="8" class="tex" id="contacto"><?=stripslashes($nf['contacto']); ?></textarea></td>
          </tr>
          <tr>
            <td align="left" class="arial14Negro" style="padding:10px 0"><strong>Mapa</strong></td>
            <td align="left" style="padding:10px 0"><textarea name="mapa" cols="80" rows="8" class="tex" id="mapa"><?=stripslashes($nf['mapa']); ?></textarea></td>
          </tr>
          <tr>
