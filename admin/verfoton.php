...
$rsx=$bd->ejecutar("select id from foto where id_nota=$id order by id desc");	
$ln=$bd->ejecutar("select * from nota where id_nota=$id order by id_nota desc");	
$kln=$bd->obtener_fila($ln,0);
      ...
      <td align="center" ><table width="100%" border="0" align="center" cellpadding="4" cellspacing="4" >
        <tr class="columna">
          <td align="left"  class="negro1"><table width="100%" border="0" align="center" cellpadding="4" cellspacing="4" >
            <tr>
              <td width="703" align="center" class="tituloNota"><span class="Verdana16Ngo"><strong>Fotografia :. <?=$kln['titulo'];?> 
                    <a href="upfoto.php?idnota=<?=$id;?>&ir=gal"><img src="imagenes/m.png" width="24" height="20" border="0" /></a></strong></span></td>
              <td width="145" align="center" class="tituloNota"><a href="vernota.php" class="georgia19Gris">Regresar</a></td>
            </tr>
		...
		while($row = $pagedResults->fetchPagedRow()) {
			$ids.=','.$row;
						...
						$busq=$bd->ejecutar("SELECT  *  FROM foto  where id in ($ids) order by id desc");
 				...
 				?>
                    <tr>
                      ...
                      <td width="100%" align="center" valign="top" height="66"><table width="97%" cellpadding="0" >
                        <tr>
                          <td width="201" height="87" valign="top" ><img src="<?=$row5['url']?><?=$row5['id']?>_4z.jpg" border="0" width="130" style="max-height:90px"   /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td class="piefoto"><table width="69" border="0" align="center" class="otrasnotas">
                            <tr>
                              <td ><a href="crop3.php?id=<?=$row5['id'];?>&ir=gal" title="Volver a Recortar"><img src="imagenes/pik.png" width="21" height="21" border="0" /></a></td>
                              <td ><a href="gal.php?idnota=<?=$row5['id'];?>&r=nota" class="text1"><img src="imagenes/up.png" border="0" title="Modificar" /></a></td>
                              <td><a href="delfoto.php?id=<?=$row5['id'];?>&r=nota" class="text1"  onclick = "if (! confirm('¿Realmente desea eliminar la foto?')) return false;"><img src="imagenes/del.png" border="0" title="Eliminar" /></a></td>
                            </tr>
                          </table></td>
                        </tr>
                      </table></td>
