...
$images_path = $_SESSION['theurl'];  //replace this with the path where your images are stored, relative to the directory this script will run from
...
$max_width = $width; //isset($_POST['max_width']) ? $_POST['max_width'] : false;
$max_height = $height; //isset($_POST['max_height']) ? $_POST['max_height'] : false;
...
die('{"success":"'.$thumb.'"}');
?>
<script language="javascript">document.location="adminnotas.php";</script>
