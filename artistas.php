...
<title>Instituto Veracruzano de la Cultura :: CREADORES</title>
<link href='http://fonts.googleapis.com/css?family=Cabin+Condensed:300|Open+Sans+Condensed:300' rel='stylesheet' type='text/css'>
...
<div style="width: 930px; float: left;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="17%" height="64" align="left" bgcolor="#C41230" style="padding:10px"><a href="artistas.php?secc=0" class="recintos">Creadores</a></td>
...
echo $kaso['nombre'];
      ...
      <!-- SE QUITO LO ANTERIOR PARA QUITAR EL LOGGEO A ARTISTAS 01/07/2015 a las 5.49pm -->
