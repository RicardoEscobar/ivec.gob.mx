          ...
          <table width="915" border="0" align="center" cellpadding="5" cellspacing="0">
            ...
            <tr>
              ...
              <tr width="626" align="left" bgcolor="#FFFFFF" class="negro14">
                <td ><table bgcolor="#CEFFED"><tr><td width="150px"></td><td width="326px" bgcolor="#BBF2D2"  border="1" ><p>Para concertar audiencia
                    <br />
comunicarse con los particulares<br /><br />
Lic. Dalia Gutiérrez Lagunas<br />
Teléfono Veracruz :  01(229)932 13 31 <br />
Teléfono Xalapa &nbsp;&nbsp;&nbsp;: 01(228)818 04 12 <br />
                Correo :  dgutierrezlagunas@yahoo.com.mx</p>
Lic. Antonio Gutiérrez Bonilla<br />
Teléfono Veracruz :  01(229)932 13 31 <br />
Teléfono Xalapa &nbsp;&nbsp;&nbsp;: 01(228)818 04 12<br />
                Correo :  antoniobonillaivec@yahoo.com.mx </p></td><td width="150px"></td></tr></table></td></tr>
            <tr>
                  ...
                  <tr>
                    <td align="left" valign="top"> 
                      <select name="destino" id="destino" style="width:100%">
                        <option value="jduarteb@ivec.gob.mx ">Director de la Pinacoteca Diego Rivera</option>
                        <option value="jesculturas@hotmail.com">Director del Jardín de las Esculturas</option>
                       <!-- <option value="xalapagac@gmail.com">Directora de la Galería de Arte Contemporáneo</option> -->
                        <option value="mzamudio@ivec.gob.mx">Director del Teatro de la Reforma </option>
                      </select></td>
                  </tr>
                  <tr>
                    <td align="left" valign="top">&nbsp;</td>
