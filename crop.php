...
$id=$_GET['id'];
$_SESSION['theidfoto']=$id;
$r=$_GET['r'];
if ($r!=''){ $_SESSION['rrr']=$r; } 
$rs3=$bd->ejecutar("select * from artistas_fotos where id=$id order by id desc limit 1");
			$row2=$bd->obtener_fila($rs3,0);
			$nompic1=$row2['id'];
			$url=$row2['url'].$row2['id'].'_3.jpg';
			if (!file_exists($url))
			{
...
<tr>
  <td bgcolor="#FFFFFF" > &nbsp; &nbsp; Puedes usar <img src="imagenes/crop.jpg" width="17" height="18" border="0" /> para acoplar el encuadre al m&aacute;ximo tama&ntilde;o, este encuadre aparecer&aacute; en el diaporama principal</td>
    ...
    <td height="500" align="center" valign="middle" bgcolor="#000000"  style="">
      ...
      <div id="main">
        ...
        <td height="37" align="left" class="bcoabajo" ></td>
  </tr>
</table>
</body>
</html> 