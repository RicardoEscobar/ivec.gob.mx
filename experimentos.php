...
<script> 
 ...
 function MM_preloadImages() { //v3.0
  ...
  $buscaim=$bd->ejecutar("select * from anuncio where vencimiento>='$hoy' order by desc() limit 8");
  $kf1=$bd->obtener_fila($buscaim,0);
  $laf1='admin/'.$kf1['url'].$kf1['id'].'_g.jpg';
  $lac1='admin/'.$kf1['url'].$kf1['id'].'_c.jpg';
  $laurl1es=$kf1['link'];
  if (trim($laurl1es)==''){ $laurl1es='#1'; }
...
$("#laurlinadora").attr("href","<?=$laurl1es?>");
try{
	$("#laurlinadora").attr("target","_blank");
} catch(err){}
<? if ($laurl1es=='#1'){ ?>
$("#laurlinadora").removeAttr("href");
$("#laurlinadora").removeAttr("target");
<? } ?>
setTimeout("fout()", 100);
...
$("#laurlinadora").attr("href","<?=$laurl2es?>");
try{
	$("#laurlinadora").attr("target","_blank");
} catch(err){}
<? if ($laurl2es=='#2'){ ?>
...
$("#laurlinadora").attr("href","<?=$laurl3es?>");
try{
	$("#laurlinadora").attr("target","_blank");
} catch(err){}
<? if ($laurl3es=='#3'){ ?>
...
$("#laurlinadora").attr("href","<?=$laurl4es?>");
try{
	$("#laurlinadora").attr("target","_blank");
} catch(err){}
<? if ($laurl4es=='#4'){ ?>
...
$("#laurlinadora").attr("href","<?=$laurl5es?>");
try{
	$("#laurlinadora").attr("target","_blank");
} catch(err){}
<? if ($laurl5es=='#5'){ ?>
...
$("#laurlinadora").attr("href","<?=$laurl6es?>");
try{
	$("#laurlinadora").attr("target","_blank");
} catch(err){}
<? if ($laurl6es=='#6'){ ?>
...
$("#laurlinadora").attr("href","<?=$laurl7es?>");
try{
	$("#laurlinadora").attr("target","_blank");
} catch(err){}
<? if ($laurl7es=='#7'){ ?>
...
$("#laurlinadora").attr("href","<?=$laurl8es?>");
try{
	$("#laurlinadora").attr("target","_blank");
} catch(err){}
<? if ($laurl1es=='#8'){ ?>
...
<div style="width:100%; background-image:url(<?=$leurl;?>);  background-position:top; background-repeat:no-repeat;">
  ...
  <tr>
    <td rowspan="4" valign="top"><a id="laurlinadora" href="#" target="_blank"><img src="<?=$laf1?>" name="imagprin" width="600" height="350" id="imagprin" style="cursor:pointer; border:0px" /></a></td>
      ...
      <div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: #002749;"><strong>RADIO IVEC</strong></div>
        ...
        <tr><td height="160px"></td></tr>
  			...
  			<tr>
                ...
                <script type="text/javascript" src="http://www.netandino.com/radios/swfobject.js"></script><title>Theme kleur</title> 
 <div id="GN Player"><a href="http://get.adobe.com/flashplayer/">Reproductor Flash Player</a><a href="http://www.macromedia.com/go/getflashplayer"></a> paraa ver a este reproductor</div>
 <script type="text/javascript"> 
 var gn = new SWFObject("http://www.netandino.com/radios/player.swf","ply","545","55","9","#FFFFFF"); 
 gn.addParam("allowfullscreen","true"); 
 gn.addParam("allowscripaccess","always"); 
 gn.addParam("flashvars","file=http://s18.myradiostream.com:5072/;stream.nsv&type=mp3&skin=http://www.netandino.com/radios/theme.swf&volume=80&autostart=false"); 
 gn.write("GN Player"); 
 </script>
        </td>
        </tr>
        <tr><td>
        <SCRIPT type="text/javascript" SRC="http://djspinnercee.servemp3.com:32768/php-cgi/scaststatus_x.php?index=5&host=78.129.224.19&port=24548"></SCRIPT>
        <script type="text/javascript" src="http://shoutcast.mixstream.net/js/song/uk18-free:5072"></script>
