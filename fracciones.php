          ...
          <td align="center">
            <table width="600" border="0" align="center" cellpadding="5" cellspacing="0" >
              ...
              <tr class="Hevel16Gris" ><? } ?>
				...
				<? if ($rowl['numero']==1){ $urlxc='F1MarcoLegal';} 
					else if ($rowl['numero']==3){ $urlxc='directorio';}
				 		else if ($rowl['numero']==14){ $urlxc='pruebaFraccion';} else { $urlxc='datosf'; } 
				?>
                ...
                <a href="<?=$urlxc?>.php?id=<?=$rowl['id'];?>" class="negro12">
				  ...
				  ?><br /><span style="font-size:11px">Actualizado Diciembre 2016 </span>
