...
<div id="openModal" style="display:block" class="modalDialog">
    <div>
    	<p class="txt-elecciones">Este sitio web tiene fines exclusivamente informativos, y ha sido modificado temporalmente con motivo del proceso electoral 2015-2016, en cumplimiento a lo ordenado en los artículos 134 de la Constitución Política de los Estados Unidos Mexicanos, 79 de la Constitución Política del Estado de Veracruz y 71 del Código Electoral de esta Entidad Federativa.</p>    
    	<h1 class="btn-regresar-home" onclick="location.href='#close'"><a href="#close" title="Cerrar" class="closers">Ir al Sitio Principal</a></h1>
    </div>
</div>
...
<div style="width:930px; margin:auto;  margin-top:3px;">
	...
	<!--<div align="center" style="margin:auto; width:930px; background-color:#FFF; border:#F8F8F8 groove 1px; min-height:160px;"><a a href="http://litorale.com.mx/ivec/admin/convocatorias/2016-09-13/ConvocatoriaApoyo2016.pdf" target="_blank"  title="Apoyo a la Creación y desarrollo Artístico 2016"><img src="imgs/ApoyoCreacion.jpg" width="930" height="160" align="middle" style="padding:0 3px 3px 0"  /></a></div>-->

	<!--<div align="center" style="margin:auto; width:930px; background-color:#FFF; border:#F8F8F8 groove 1px; min-height:160px;"><a a href="http://www.litorale.com.mx/Virtual/feriadellibro/index.html" target="_blank"  title="Recorrido Virtual de la 27a Feria del Libro Xalapa 2016">
      <img src="img/FERIA360.jpg" width="930" height="160" align="middle" style="padding:0 3px 3px 0"  /></a></div>-->
<table><tr><td>
<td><div align="left" style="margin:auto; width:307px;  margin-top:10px; min-height:120px;"><a a href="http://recorridovirtual.ivec.gob.mx" target="_blank"  title="Recorridos Virtuales del IVEC 360">
      <img src="imgs/Rv360.png" width="307" height="120" align="right" style="padding:0 3px 3px 0"  /></a>
</div></td>
<td><div align="center" style="margin:auto; width:307px;  margin-top:10px; min-height:120px;"><a title="Vanguardia Tecnlógica del IVEC"><img src="imgs/Vanguardia.png" width="307" height="120" align="right" style="padding:0 3px 3px 0"  /></a>
</div></td>

<td><div align="right" style="margin:auto; width:307px;  margin-top:10px; min-height:120px;"><a a href="http://kioscodigital.ivec.gob.mx" target="_blank"  title="Kioscos Digitales">
      <img src="imgs/Kiosco.png" width="307" height="120" align="right" style="padding:0 3px 3px 0"  /></a>
</div></td>
</tr>
</table> 

<table><tr><td>
<td><div align="left" style="margin:auto; width:307px;  margin-top:10px; min-height:120px;"><a a href="http://litorale.com.mx/ivec/admin/convocatorias/2016-06-06/DirectorioCasasCultura2016.pdf" target="_blank"  title="Directorio de Casas de Cultura">
      <img src="imgs/DirCasas.png" width="307" height="120" align="right" style="padding:0 3px 3px 0"  /></a>
</div></td>
<td><div align="center" style="margin:auto; width:307px;  margin-top:10px; min-height:120px;"><a href="http://litorale.com.mx/ivec/admin/convocatorias/2016-10-03/Casas2016.pdf" title="Descubre lo nuevo del IVEC"><img src="imgs/DescubreCasas.png" width="307" height="120" align="right" style="padding:0 3px 3px 0"  /></a>
</div></td>

<td><div align="right" style="margin:auto; width:307px;  margin-top:10px; min-height:120px;"><a a href="https://www.google.com/maps/d/u/1/edit?mid=1PWeXmo4NxXv2qhCyGlQbtMrRvFQ" target="_blank"  title="Mapa de Casas de Cultura">
      <img src="imgs/MapaCasas.png" width="307" height="120" align="right" style="padding:0 3px 3px 0"  /></a>
</div></td>
</tr>
</table>      

<table><tr><td>
<td><div align="left" style="margin:auto; width:307px;  margin-top:10px; min-height:120px;"><a a href="http://pedivec.litorale.com.mx" target="_blank"  title="Plataforma de Educación a Distancia del IVEC">
...
<td><div align="center" style="margin:auto; width:307px;  margin-top:10px; min-height:120px;"><a a href="http://litorale.com.mx/ivec/subdirecciones41.php" target="_blank"  title="Portal de Ética">
      <img src="imgs/etica.png" width="307" height="120" align="right" style="padding:0 3px 3px 0"  /></a>
</div></td>
...
<div style="width: 100%; float: left; height: auto; margin-top: 10px;"><table width="930" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="2"><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: #002749;"><strong>Artistas Destacados PECDAV</strong></div></td>
  ...
  <tr>
    <td valign="top" bgcolor="" style="padding:0 0 7px 0"> 
    <a href="http://pecdaxx.litorale.com.mx" target="new"><img src="imagenes/PECDAXX.jpg" width="470" height="315" alt="Artistas Destacados PECDAV">        

		</td>
    <td valign="top" bgcolor="#F2F2F2">&nbsp;</td>
    <td valign="top" bgcolor="#FFFFFF" style="padding:0 0 7px 0"><div>
      <table cellpadding="0" cellspacing="0" width="100%"    >
        <tr>
