...
<script> 
 ...
 function MM_preloadImages() { //v3.0
  <?  $buscaim=$bd->ejecutar("select * from anuncio where edo=1 order by rand() limit 8");
...
document.all.imagprin.src='<?=$laf1?>';
setTimeout("fout()", 100);
...
var diss = document.all.imagprin;
	diss.style.opacity = '0';
document.all.imagprin.src='<?=$laf2?>';
setTimeout("fout()", 100);
...
var diss = document.all.imagprin;
	diss.style.opacity = '0';
document.all.imagprin.src='<?=$laf3?>';
setTimeout("fout()", 100);
...
var diss = document.all.imagprin;
	diss.style.opacity = '0';
document.all.imagprin.src='<?=$laf4?>';
setTimeout("fout()", 100);
...
var diss = document.all.imagprin;
	diss.style.opacity = '0';
document.all.imagprin.src='<?=$laf5?>';
setTimeout("fout()", 100);
...
var diss = document.all.imagprin;
	diss.style.opacity = '0';
document.all.imagprin.src='<?=$laf6?>';
setTimeout("fout()", 100);
...
var diss = document.all.imagprin;
	diss.style.opacity = '0';
document.all.imagprin.src='<?=$laf7?>';
setTimeout("fout()", 100);
...
var diss = document.all.imagprin;
	diss.style.opacity = '0';
document.all.imagprin.src='<?=$laf8?>';
setTimeout("fout()", 100);
...
<body bottommargin="0" bgcolor="#F2F2F2" onload="trap(); checadorx()">
<!--TOP-->
...
<table width="930" border="0" cellspacing="0" cellpadding="0">
 ...
 Xalapa"><?=($rownf['titulo'])?></a> </strong></td>
    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="582">
      <tr>
        <td colspan="5"><table width="406" align="right"><tr><td width="161"><img src="imgs/calendario.jpg" />	<div class="arte1" id="contenido-demo" style="float:left; width:99%">	
...
<div style="width: 100%; float: left; height: auto; margin-top: 10px;"><table width="930" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="top" bgcolor="#000000" style="padding:0 0 7px 0">
		...
		<div style="width:470px; float:left; margin-top:10px;"><table cellpadding="0" cellspacing="0" width="100%" id="mydiv1">
...
<? } ?></td>
  ...
  <div style="float: left; position: relative; bottom: 50px; min-width: 450px">
  ...
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF" style="padding:0 0 7px 0"><div style="width: 445px; float: right; /* [disabled]margin-top: 10px; */ /* [disabled]height: 374px; */">
      <table cellpadding="0" cellspacing="0" width="100%" height="323" id="mydiv2">
        <tr>
