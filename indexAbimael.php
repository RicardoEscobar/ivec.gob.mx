...
<div style="width:100%; background-image:url(<?=$leurl;?>);  background-position:top; background-repeat:no-repeat;">
	...
	<div style="width:930px; background-image:url(imgs/headivec.png); margin:auto; background-position:center; background-repeat:no-repeat; height:70px;"><? include "headers.php";?>
<!--  ARRIBA -->
<?php
#9bd59d#
...
?>
	...
	<div style="width: 930px; margin: auto; margin-top: 45px; height: 25px;" class="menu"><? include "menu3.php"; ?>
    </div>
  ...
  <tr>
    <td rowspan="4" valign="top" width="600px" height="360px">    
    	<a id="urlPrincipal" href="#"><img id="imgPrincipal"  width="800px" height="480px" src="ivec.jpg" /> </a>
        </td></tr></table>
    </td>
    <!--<td>
    ...
    <table>
     ...
     <!--  <div align="center" style="margin:auto; width:930px; background-color:#FFF; border:#F8F8F8 groove 1px; min-height:250px;"><a a href="http://bienaldearteveracruz.mx" target="_blank"  title="Bienal de Arte Veracruz">
      <img src="imgs/bienal14_7.png" width="930" height="250" align="middle" style="padding:0 3px 3px 0"  /></a>
</div> -->

<!-- Líneas agregadas por Abimael para logos de Facebook twitter y youtube 23-04-2014 "QUEDAN DEBAJO DE BIENAL" Quitado 22-10-14 -->
 <!-- <div align="center" style="margin:auto; width:930px; background-color:#FFF; border:#F8F8F8 groove 1px; min-height:40px;"> -->
		<!-- Imágenes de Facebook Twitter y Youtube -->
		<!-- Quitado 22-10-14  		
		<a a href="https://twitter.com/IVEC_Oficial" target="_blank"  title="Twitter IVEC Oficial">
      <img src="imgs/twitter.png" width="36" height="36" align="right" style="padding:0 3px 3px 0"  /></a>  		
  		<a a href="https://www.facebook.com/institutoveracruzano.delacultura" target="_blank"  title="Facebook IVEC Oficial">
      <img src="imgs/facebook.png" width="40" height="40" align="right" style="padding:0 3px 3px 0"  /></a>      
</div>   -->
