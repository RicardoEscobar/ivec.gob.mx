...
<div align="center" style="margin:auto; width:930px; background-color:#FFF; border:#F8F8F8 groove 1px; min-height:250px;"> <a href= "javascript:void(0);" 
onclick="javascript:window.open('https://www.youtube.com/channel/UCBs_3i0bypMwaMk8ScHNjEw','_blank'); window.open('http://litorale.com.mx/ivec/admin/convocatorias/2015-07-15/XVProgramaPromotoresLectura.pdf','_blank');window.open('http://litorale.com.mx/ivec/admin/convocatorias/2015-07-07/FeriaDelLibroInfantilyJuvenil2015.pdf','_blank');">
<img src="imgs/feriaBanner.jpg" width="930" height="250" align="middle" style="padding:0 3px 3px 0"  /></a>
</div>
