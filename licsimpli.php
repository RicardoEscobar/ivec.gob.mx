          ...
          <td colspan="4" align="left" class="Arial12Nego"><table width="600" border="0" align="center" cellpadding="5" cellspacing="0" >
            ...
            <tr class="Hevel16Gris" >
              <td align="left" valign="middle"  class="Arial12Rojo" style="font-size: 19px" width="300"> 
                <span class="negro19"> Licitaciones Simplificadas - Invitación a Cuando Menos tres Personas </span><br />
          ...
          <td colspan="4" align="left" class="Arial12Nego"><table width="600" border="0" align="center" cellpadding="5" cellspacing="0" >
            ...
            <tr class="Hevel16Gris" >
              <td align="left" valign="middle"  class="Arial12Rojo" style="font-size: 19px" width="300"><ul type=circle>
                <li><a href="http://www.litorale.com.mx/ivec/LSimpli2016.php"><span class="negro19">Ejercicio 2016</span><br /><br /></li>
                <li><a href="http://www.litorale.com.mx/ivec/LSimpli2015.php" target="_blank"><span class="negro19">Ejercicio 2015</span><br /><br /></li>
                <li><a href="http://www.litorale.com.mx/ivec/LSimpli2014.php" target="_blank"><span class="negro19">Ejercicio 2014</span><br /><br /></li>
              </ul></td>
            </tr>
          </table></td>
        </tr>
