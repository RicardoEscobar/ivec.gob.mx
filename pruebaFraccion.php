        ...
        <tr>
          <td colspan="4" align="left" class="Arial12Nego"><table width="600" border="0" align="center" cellpadding="5" cellspacing="0" >
            ...
            <tr class="Hevel16Gris" >
              <td align="left" valign="middle"  class="Arial12Rojo" style="font-size: 19px" width="300"><strong>Fracción XIV.- </strong> <span class="negro19">
                 Adquisiciones, Arrendamientos y Servicios <!--<?=$rowl['titulo']?>-->
                </span><br />
                <span style="color:#333; font-size: 15px">
                Responsable de la Información: Subdirección Administrativa.<br /> 
                </span></td>
          ...
          <td colspan="4" align="left" class="Arial12Nego"><table width="600" border="0" align="center" cellpadding="5" cellspacing="0" >
            ...
            <tr class="Hevel16Gris" >
              <td align="left" valign="middle"  class="Arial12Rojo" style="font-size: 19px" width="300"><ul type=circle>
                <li><a href="http://www.litorale.com.mx/ivec/admin/fracciones/TarjetasInformativas/tarjetaFraccionXIV.pdf" target="_blank"><span class="negro19">Licitación Pública</span><br /><br /></li>
                <li><a href="http://www.litorale.com.mx/ivec/licsimpli.php" target="_blank"><span class="negro19">Licitaciones Simplificadas / Invitación a Cuando Menos Tres Personas</span><br /><br /></li>
                <li><a href="http://www.litorale.com.mx/ivec/adjudica.php" target="_blank"><span class="negro19">Adjudicaciones Directas</span><br /><br /></li>
                <li><a href="http://www.litorale.com.mx/ivec/progAnual.php" target="_blank"><span class="negro19">Programa Anual de Adquisiciones</span><br /><br /></li>
              </ul></td>
            </tr>
          </table></td>
        </tr>
