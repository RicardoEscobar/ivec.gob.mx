...
var arrExtensions=new Array("pdf", "doc", "docx");
var objInput = objForm.elements["curri"];
...
if (!blnExists)
alert("el curriculum debe estar en formato de Word o PDF y no debe ser mayor a 5MB");
return blnExists;
}
</script>
<body>
...
<div style="width: 930px; float: left; margin: 10px 0;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td align="center"><form name="reduce" method="post" action="addartista.php?id=<?=$id?>"  onsubmit="return Verify(this);"  enctype="multipart/form-data">
