  ...
  <br /></td>
      ...
      <tr>
        <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="48%" align="left"><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-11];?>;"><strong>¿Qué es una sala de lectura?</strong></div></td>
            <td width="1%" height="10" rowspan="2">&nbsp;</td>
            <td><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-11];?>;"> <strong>¿Qué es el Día Mundial del Libro y Derecho de Autor?</strong>            </div></td>
          </tr>
          <tr>
