...
while(@$rownf=@$bd->obtener_fila($bn,0)) {
  ...
  <br /></td>
      ...
      <tr>
        <td rowspan="2"><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-11];?>;"><strong>Contacto</strong></div></td>
        <td rowspan="2">&nbsp;</td>
        <td><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-11];?>;"><strong>Convocatoria</strong></div></td>
      </tr>
      <tr>
