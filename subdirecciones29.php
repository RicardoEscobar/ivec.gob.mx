    ...
    <input name="Botón" type="button" class="naranja121" value="Cambiar" onclick="cambia()" />
      ...
      <tr>
        <td colspan="3"><table width="930" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="57%"><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-26];?>;"><strong>Actividades</strong></div></td>
            <td height="10" rowspan="2">&nbsp;</td>
            <td><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-26];?>;"><strong>Areas</strong></div></td>
          </tr>
          <tr>
