...
<tr>
<td width="21%" height="64" align="center" bgcolor="<?=$colores[$id-26]?>" style="padding:4px 6px"><img src="recinto/<?=$id?>.png" height="90"/></td>
<td width="79%" align="left" bgcolor="<?=$colores[$id-26]?>" class="recintos" style="padding:6px 6px"><?=$krecin['nombre'];?></td>
<!-- Se cambia esta linea el 10/03/2015 <td height="64" align="left" bgcolor="<?=$colores[$id-26]?>" class="recintos" style="padding:6px 6px"><?=$krecin['nombre'];?></td>-->
</tr>
</table>
</div>
    ...
    <input name="Botón" type="button" class="naranja121" value="Cambiar" onclick="cambia()" />
      ...
      <tr>
        <td colspan="3"><table width="930" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="57%"><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-26];?>;"><strong>Misión</strong></div></td>
            <td height="10" rowspan="2">&nbsp;</td>
            <td><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-26];?>;"><strong>Visión</strong></div></td>
          </tr>
          <tr>
      ...
      <tr>
        <td><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-26];?>;"><strong>Dirección</strong></div></td>
        <td>&nbsp;</td>
        <td><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-26];?>;"><strong>Mapa</strong></div></td>
      </tr>
      <tr>
      ...
      <tr>
        <td valign="top" style="padding:7px 5px"><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-26];?>;"><strong>Contacto</strong></div></td>
        <td>&nbsp;</td>
        </tr>
      <tr>
