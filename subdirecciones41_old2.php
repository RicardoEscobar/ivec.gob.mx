  ...
  <div  >
   ...
   <div style="float:left; width:930px; height:auto;" id="eldiv1">
    <table width="930" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center" valign="middle" bgcolor="#FFFFFF" style="padding:5px"></td>
        <td>&nbsp;</td>
        <td rowspan="2" valign="top" bgcolor="#FFFFFF">
        <table>
              <tr>
                    <td colspan="5" valign="top"><table width="406" align="right">
                    <tr>
                      <td width="161"><img src="imgs/calendario.jpg" />	
                      </td><td width="202" class="gris25" id="fechadia"><?=$dia?> <?=$mes?></td>
            </tr></table></td>
        </tr>
      ...
      <tr>
        <td colspan="5" valign="top" class="naranja121">
                ...
                <tr>
        <td width="117" rowspan="2" align="center" class="negro12"></td>
        <td class="negro12"></td>
        <td rowspan="2" class="azul12"></td>
        <td rowspan="2" class="negro15"></td>
        <td rowspan="2">&nbsp;</td>
        </tr>
      <tr>
        <td class="negro12"></td>
...
while(@$rownf=@$bd->obtener_fila($bn,0)) {
  ...
  <br /></td>
      ...
      <tr>
        <td rowspan="2"><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-26];?>;"><strong>Contacto</strong></div></td>
        <td rowspan="2">&nbsp;</td>
        <td><div class="especial" style="float: left; padding: 4px 7px; min-width: 195px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-26];?>;"><strong>Convocatoria</strong></div></td>
      </tr>
      <tr>
        <td rowspan="2" valign="top" bgcolor="#FFFFFF" style="padding:15px"> <p> <span class="Arial12Nego"><strong><a href="CONVOCATORIA2012.doc" class="Arial12Nego">Descargar :<br />
Convocatoria  2012</a></span></p></td>
      </tr>
      <tr>
