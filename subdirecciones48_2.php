...
<td>&nbsp;</td>        
        <td rowspan="2"><div class="especial" style="float: left; padding: 4px 7px; min-width: 300px; border-radius: 7px 7px 0 0; background-color: <?=$colores[$id-26];?>;"><strong>Directorio Telefónico</strong></div></td>  
<td>&nbsp;</td>
...
?>
      ...
      <td>&nbsp;</td>   
      <td rowspan="2" valign="top" bgcolor="#FFFFFF" style="padding:15px"><a a href="img/DirectorioCasas.pdf" target="_blank"  title="Directorio Telefonico de Casas de la Cultura">
      <img src="imgs/CasasCultura.jpg" width="330" height="80" align="center" style="padding:0 10px 10px 0"  alt="" /></a></td>
		<td>&nbsp;</td>      
      <td rowspan="2" valign="top" bgcolor="#FFFFFF" style="padding:15px"> <p> <span class="Arial12Nego"><strong><a href="CONVOCATORIA2012.doc" class="Arial12Nego">Descargar :<br />
			Convocatoria  2012</a></span></p></td>
      </tr>
