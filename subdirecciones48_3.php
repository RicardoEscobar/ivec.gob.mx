...
cal.getFirstDate();
    ...
    <input name="Botón" type="button" class="naranja121" value="Cambiar" onclick="cambia()" />
      ...
      <tr>&nbsp;</tr> <tr>&nbsp;</tr> <tr>&nbsp;</tr>
      <tr>					
      		<td colspan="5" align="right" class="naranja121"><a href="/ivec/admin/convocatorias/2014-12-15/MapaCultural.jpg" class="naranja121"> Ver Mapa De Casas de la Cultura</a></td>
 		</tr>
...
?>
      ...
      <td>&nbsp;</td>   
      <td rowspan="2" valign="top" bgcolor="#FFFFFF" style="padding:10px"><a a href="img/DirectorioCasas.pdf" target="_blank"  title="Directorio Telefonico de Casas de la Cultura">
      <img src="imgs/CasasCultura.jpg" width="240" height="80" align="center" style="padding:0 10px 10px 0"  alt="" /></a></td>
		<td>&nbsp;</td>      
      <td rowspan="2" valign="top" bgcolor="#FFFFFF" style="padding:10px"><a a href="img/Cartelera_CasasCultura_Sept.pdf" target="_blank"  title="Directorio Telefonico de Casas de la Cultura">
      <img src="imgs/CarteleraCasas.png" width="200" height="80" align="center" style="padding:0 10px 10px 0"  alt="" /></a></td>
		<td>&nbsp;</td>      
      <td rowspan="2" valign="top" bgcolor="#FFFFFF" style="padding:10px"> <p> <span class="Arial12Nego"><strong><a href="http://litorale.com.mx/ivec/admin/convocatorias/2014-12-11/Resultados2014.pdf" class="Arial12Nego">Descargar:<br />
			Resultados de la 2a Convocatoria de Estimulos a Proyectos Culturales y Artísticos de Casas de la Cultura  2014</a></span></p> </td>	
      </tr>
      </table>
      </div>
      </div>
